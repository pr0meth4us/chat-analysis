def parse_generic_json(data):
    messages = []
    # Assume data is a list of message objects
    if not isinstance(data, list):
        # If it's a dictionary, try to find a common key for messages
    ...
    for msg in data:
        ...
        # General structure with 'sender', 'message', 'timestamp'
            ...
            messages.append({'source': msg.get('source', 'Generic JSON'), 'timestamp': msg['timestamp'], 'sender': msg['sender'], 'message': msg['message']})
