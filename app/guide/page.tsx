                ...
                <div className="max-w-6xl mx-auto p-4 sm:p-6 md:p-8">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="mb-16">
                        <Card className="glass overflow-hidden">
                            ...
                            <CardContent className="pt-8"><div className="grid gap-8 md:gap-12"><WorkflowStep step={1} title="Upload Your Data" description="Start by uploading your chat history files directly into your browser. Chat Analyzer supports JSON, HTML exports, and ZIP archives from popular platforms." icon={FileUp} delay={0} /><WorkflowStep step={2} title="Filter Participants" description="Group participants into 'Me' and 'Other' categories, or remove bots and unwanted senders for cleaner analysis. This process runs entirely in your browser." icon={Filter} delay={0.1} /><WorkflowStep step={3} title="Run Analysis" description="Select your desired analysis modules and let Chat Analyzer's AI process your conversations to extract meaningful insights. All analysis runs locally in your browser, using a local database for efficient storage." icon={BrainCircuit} delay={0.2} /><WorkflowStep step={4} title="Explore Results" description="Dive into your interactive dashboard, search for keywords, and discover the stories your conversations tell. Your results are generated and stored locally." icon={BarChart3} delay={0.3} /></div></CardContent>
                        </Card>
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mb-8">
                        <Card className="glass overflow-hidden"><CardHeader className="bg-gradient-to-r from-blue-500/10 to-purple-500/10"><CardTitle className="flex items-center gap-3 text-2xl"><Target className="h-7 w-7 text-primary" />About Chat Analyzer</CardTitle></CardHeader><CardContent className="pt-6"><div className="prose prose-invert max-w-none"><p className="text-muted-foreground leading-relaxed mb-4">Chat Analyzer is a powerful tool designed to help you understand your digital conversations better. Whether you're analyzing personal relationships, communication patterns, or just curious about your messaging habits, this platform provides deep insights through advanced natural language processing and machine learning techniques.</p><p className="text-muted-foreground leading-relaxed">All analysis happens locally and solely within your web browser, utilizing a local database for efficient processing and storage. Your data remains on your device and is never stored permanently on any external servers or transmitted elsewhere. Chat Analyzer empowers you with insights and full control over your personal communications.</p></div></CardContent></Card>
                    </motion.div>
                </div>
            </main>
        </div>
